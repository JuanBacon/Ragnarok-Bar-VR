...
public class Dardos : MonoBehaviour
{
    ...
    bool P1Turn = true;
    bool P2Turn = false;
    enum Nlanzamientos { t1 = 1, t2, t3 };
    int turnos = 1;
    Nlanzamientos Lanzamiento = Nlanzamientos.t1;

    public Vector3 dartOffset;
    public Vector3 dartAngle;
    public GameObject HachitaPro;
    GameObject HachaActual;
    Queue<GameObject> Hachas = new Queue<GameObject>();
